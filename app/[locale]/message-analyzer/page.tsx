...
import { Search, MessageSquare, ShieldAlert, AlertCircle, ShieldCheck, ArrowRight, Loader2, Sparkles, Zap } from "lucide-react";
      ...
      <div className="max-w-4xl mx-auto space-y-12">
        ...
        >
          <div className="space-y-4">
             ...
             <textarea
               className="w-full h-64 bg-white/5 border border-white/10 rounded-3xl p-6 focus:outline-none focus:border-primary/30 transition-all resize-none text-white/80 text-lg"
